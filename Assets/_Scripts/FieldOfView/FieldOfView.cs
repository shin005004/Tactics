...
public class FieldOfView : MonoBehaviour
{
    ...
    EdgeInfo FindEdge(ViewCastInfo minViewCast, ViewCastInfo maxViewCast)
    {
        ...
        for (int i = 0; i < edgeResolveIterations; i++)
        {
            ...
            // 이분탐색을 통해서 레이캐스팅 횟수를 최소화 함
            //bool edgeDistThresholdExceeded = Mathf.Abs(minViewCast.dist - maxViewCast.dist) > edgeDistThreshold;
    ...
    // Struct to catch raycast information
    ...
    // struct for edge finding information
